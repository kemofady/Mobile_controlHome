...
Mobile_controlHome\ (2)/Mobile_controlHome/DIO_driver/Dio_Prog.o: ../Mobile_controlHome\ (2)/Mobile_controlHome/DIO_driver/Dio_Prog.c
	...
	avr-gcc -Wall -g2 -gstabs -O0 -fpack-struct -fshort-enums -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega32 -DF_CPU=8000000UL -MMD -MP -MF"Mobile_controlHome (2)/Mobile_controlHome/DIO_driver/Dio_Prog.d" -MT"Mobile_controlHome\ (2)/Mobile_controlHome/DIO_driver/Dio_Prog.d" -c -o "$@" "$<"
